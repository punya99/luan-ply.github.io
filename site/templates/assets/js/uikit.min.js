...
! function(t, e) {
    ...
    function Le(t, e, n) {
        ...
        for (var i = W(t), r = 0; r < i.length; r++)
            for (var o = i[r].classList, s = 0; s < e.length; s++) O(n) ? o.toggle(e[s]) : We.Force ? o.toggle(e[s], !!n) : o[n ? "add" : "remove"](e[s])
    }
    ...
    function En(e, n, i) {
        var t, r, o = {};
        if ((n = k(n) ? n.options : n).extends && (e = En(e, n.extends, i)), n.mixins)
    ...
    Qn.util = Zn, Qn.data = "__uikit__", Qn.prefix = "uk-", Qn.options = {}, Qn.version = "3.7.0", ni = (ti = Qn).data, ti.use = function(t) {
            ...
            if (t[ai])
                for (var e in t[ai]) t[ai][e]._callConnected();
                ...
                toggleElement: function(e, s, a) {
                    ...
                    return new he(function(t) {
                        return he.all(W(e).map(function(t) {
                            ...
                            var o, n = (k(a) ? a : !1 !== a && u.hasAnimation ? u.hasTransition ? gi(u) : (o = u, function(t, e) {
                                    nn.cancel(t);
                                    var n = o.animation,
                                        i = o.duration,
                                        r = o._toggle;
            ...
            update: {
                    ...
                    return {
                        ...
                        columns: function(t) {
                            for (var e = [], n = 0; n < t.length; n++)
                                for (var i = Ai(t[n], "left", "right"), r = 0; r < i.length; r++) e[r] = e[r] ? e[r].concat(i[r]) : i[r];
                ...
                write: function(t) {
                    for (var e = t.columns, n = t.rows, i = 0; i < n.length; i++)
                        for (var r = 0; r < n[i].length; r++) Le(n[i][r], this.margin, 0 !== i), Le(n[i][r], this.firstColumn, !!~e[0].indexOf(n[i][r]))
                },
                events: ["resize"]
            }
        };
